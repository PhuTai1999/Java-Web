...
public class DispatchFilter implements Filter {
    ...
    private final String INIT_PAGE = "LoadInitPageServlet";
//    private final String INIT_PAGE = "overview.jsp";
...
//        }
        ...
        String url = INIT_PAGE;
        String uri = req.getRequestURI();
        if (uri.contains(".css") || uri.contains(".js") || uri.contains(".aspx") || uri.contains("jpg")) {
