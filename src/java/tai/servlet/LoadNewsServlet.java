 ...
 * @author Windows
 */
@WebServlet(name = "LoadNewsServlet", urlPatterns = {"/LoadNewsServlet"})
public class LoadNewsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            EntryDTO dtoEntry = dao.getEntry(entryID);
            ImageDAO daoImg = new ImageDAO();
            List<ImageDTO> listImg = daoImg.getImage(entryID);
            EntryDetailsDTO dto = new EntryDetailsDTO(dtoEntry, listImg);
