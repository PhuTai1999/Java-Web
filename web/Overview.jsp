<%-- 
    Document   : overview
    Created on : Sep 22, 2019, 7:24:05 PM
    Author     : Windows
--%>
...
<html lang="en-US" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Overviews - us-123my-life.simplesite.com</title>
                                    ...
                                    <div class="section">
                                        <div class="content">
                                            <table class="table" data-year="2015" data-month="11"> <!-- can be bordered, striped, hover, condensed -->
                                                <thead>
                                                    <tr>
                                                        <th name="month-year" colspan="3">${requestScope.DATE}</th>
                                                ...
                                                <tbody>
                                                    <c:forEach var="dto" items="${requestScope.RESULT}">
                                                        <c:url var="linkNews" value="loadNews">
                                                            <c:param name="entryID" value="${dto.entryID}"/>
                                                        </c:url>
                                                        <tr data-id="3232873">
                                                            <td width="60%"><a href="${linkNews}">${dto.entryName}</a></td>
                                                            <td></td>
                                                            <td></td>
                                                            <td class="align-right">${dto.publishedDate}</td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
                                            </table>
