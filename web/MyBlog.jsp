<%-- 
    Document   : MyBlog
    Created on : Sep 30, 2019, 4:39:42 PM
    Author     : Windows
--%>
                            ...
                            <div class="wrapper blog">
                                ...
                                <div class="content">
                                    <c:forEach var="dto" items="${requestScope.RESULT}">
                                        <c:url var="linkNews" value="loadNews">
                                            <c:param name="entryID" value="${dto.entry.entryID}"/>
                                        </c:url>
                                        <div class="section">
                                            <div class="content">
                                                <c:choose>
                                                    <c:when test="${dto.entry.entryType eq 1}">
                                                        ...
                                                        <div class="item">
                                                            ...
                                                            <div class="heading">
                                                                <h4><a rel="nofollow" href="${linkNews}">${dto.entry.entryName}</a></h4>
                                                            </div>
