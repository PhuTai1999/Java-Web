<%-- 
    Document   : AboutMe
    Created on : Sep 22, 2019, 10:30:25 AM
    Author     : Windows
--%>
...
<html lang="en-US" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <meta property="og:updated_time" content="2016-06-26T09:59:00.5099062+02:00">
                            ...
                            <div class="wrapper ">
                                <div class="content">
                                    <div class="section article">
                                        ...
                                        <div class="content">
                                            <p><span>${requestScope.INFO.description}</span></p>    </div>
                                    </div>
