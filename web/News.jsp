<%-- 
    Document   : news
    Created on : Sep 22, 2019, 7:10:36 PM
    Author     : Windows
--%>
...
<html lang="en-US" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>News - us-123my-life.simplesite.com</title>
        ...
        <meta property="og:updated_time" content="2016-06-26T09:58:16.5635794+02:00">
        ...
        <link rel="stylesheet" type="text/css" href="./css/9767673.design.v27169.css">
        ...
        <script type="text/javascript" src="./aspx/FrontendAppLocalePage.aspx"></script>
                                ...
                                <div class="nav-collapse collapse">
                                    <ul class="nav" id="topMenu" data-submenu="horizontal">
                                        <li class=" active " style="">
                                            <a rel="nofollow" href="loadInitPage">My Blog</a>
                                        </li><li class="  " style="">
                                            <a rel="nofollow" href="loadAboutMe">About Me</a>
                                        </li>                </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="left" class="span9"> <!-- ADD "span12" if no sidebar, or "span9" with sidebar -->
                            <div class="wrapper blog">
                                ...
                                <div class="content">
                                        <div class="section">
                                            <div class="content">
                                                <c:set var="dto" value="${requestScope.NEWS}"/>
                                                <c:choose>
                                                    <c:when test="${dto.entry.entryType eq 1}">
                                                        <div class="avatar">
                                                            <i class="icon-pencil icon-4x" title="${dto.entry.entryName}"></i>
                                                        </div>
                                                        <div class="item">
                                                            <div class="controls">
                                                                <span class="date-text">${dto.entry.publishedDate}</span>
                                                            </div>
                                                            <div class="heading">
                                                                <h4>${dto.entry.entryName}</h4>
                                                            </div>

                                                            <div class="content">
                                                                <div class="img-simple span6 pull-left">
                                                                     <c:forEach var="dtoImg" items="${dto.listImg}">
                                                                        <div class="image">
                                                                            <a rel="nofollow" data-ss="imagemodal" data-href="${dtoImg.descriptionPic}">
                                                                                <img src="${dtoImg.descriptionPic}"></a>
                                                                        </div>
                                                                    </c:forEach>
                                                                </div>

                                                                <p>${dto.entry.entryContent}</p>
                                                            </div>
                                                        </div>

                                                    </c:when>
                                                    <c:when test="${dto.entry.entryType eq 2}">
                                                        <div class="avatar">
                                                            <i class="icon-quote-left icon-4x" title="${dto.entry.entryName}"></i>
                                                        </div>
                                                        <div class="item">
                                                            <div class="controls">
                                                                <span class="date-text">${dto.entry.publishedDate}</span>
                                                    ...
                                                    <c:when test="${dto.entry.entryType eq 3}">
                                                        <div class="avatar">
                                                            <i class="icon-camera-retro icon-4x" title="${dto.entry.entryName}"></i>
                                                        </div>
                                                        <div class="item">
                                                            <div class="controls">
                                                                <span class="date-text">${dto.entry.publishedDate}</span>
                                    ...
                                    <ul class="pager">
                                        <li><a rel="nofollow" href="loadOverView">Overview</a></li>
                                    </ul>
                                </div>
                ...
                <div class="container">
                    <div class="footer-info">
                        ...
                        <div class="footer-powered-by">
                            <a rel="nofollow" href="#">Get Your own FREE website. Click here!</a>
                        </div>
                    </div>
